...
uint8_t TwoWire::requestFrom(uint8_t address, uint8_t quantity,
                             ...
                             uint8_t sendStop) {
  return ArduinoFakeInstance(Wire, this)->requestFrom(address, quantity, iaddress, isize, sendStop);
}

uint8_t TwoWire::requestFrom(uint8_t address, uint8_t quantity,
                             uint8_t sendStop) {
  return ArduinoFakeInstance(Wire, this)->requestFrom(address, quantity, sendStop);
}
